    ...
    <div>
        <div class='grid grid-cols-5 gap-10 text-center container mx-auto my-16'>
            ...
            <p class="text-md my-3 font-semibold">
             ...
             <a href="https://www.facebook.com/media/set/?set=a.2453569884799028&type=3">ইঞ্জিনিয়ার্স ডে :: ২০২৩</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2114514202037933&type=3">প্রকৌশলীদের প্রতিবাদ!</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2183435998479086&type=3">প্রিয় প্রকৌশলী :: শুভেচ্ছা অভিনন্দন ও শুভকামনা</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.1905971916225497&type=3">প্রকৌশলীদের প্রয়াণে :: আমরা শোকাহত</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
            ...
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2299272393562112&type=3">VOE :: OUR POSTERS</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2395137210642296&type=3">VOE :: OUR UPDATES</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2183468811809138&type=3">VOE :: ENGINEERS' PHOTOGRAPHY</a>
            </p>
            <p class="text-md my-3 font-semibold">
            ...
            <p class="text-md my-3 font-semibold">
             ...
             <a href="https://www.facebook.com/media/set/?set=a.2425061594316524&type=3">GTCL UPDATES :: গ্যাস ট্রান্সমিশন কোম্পানী লিমিটেড সংবাদ</a>
            </p>
            ...
            <p class="text-md my-3 font-semibold">
             ...
             <a href="https://www.facebook.com/media/set/?set=a.2440619522760731&type=3">NPCBL : নিউক্লিয়ার পাওয়ার প্লান্ট কোম্পানি বাংলাদেশ লিমিটেড সংবাদ</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full " src="../assets/updates_sponsors/nwpgcl.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2446966848792665&type=3">NWPGCL Updates:: নর্থওয়েস্ট পাওয়ার জেনারেশন কোম্পানি সংবাদ</a>
            </p>
            <p class="text-md my-3 font-semibold">
            ...
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full" src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
             <a href="https://www.facebook.com/media/set/?set=a.2192252100930809&type=3">পদ্মা সেতু :: প্রকৌশলীদের উচ্ছ্বাস</a>
            </p>
            <p class="text-md my-3 font-semibold">
                <img class="w-24 h-24 mx-auto mb-2 rounded-full" src="../assets/updates_sponsors/Voe Logo round.png" alt="ieb">
