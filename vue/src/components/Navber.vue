<template>
    <div>
      <nav
        class="px-6 py-8  md:flex md:justify-between md:items-center"
      >
          ...
          <li>
            <div class="relative">
              ...
              <button
                ...
                "
              >
                <span class="mr-4 text-lg">Subscribe</span>
                <svg
                  class="w-5 h-5 "
  ...
  <script>
    ...
    export default {
      setup() {
        ...
        const toggleHide = () => (showMenu.value = false)
        return { showMenu,  toggleNav, toggleHide };
      },
    };
  </script>